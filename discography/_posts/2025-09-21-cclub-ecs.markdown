...
- [functioning p5js sketch](https://editor.p5js.org/frederer/sketches/saybmOwu4)
- [GitHub repository](https://github.com/efredericks/p5-ecs-demo)
...
1. Create an account on the p5js editor: [p5js online editor](https://editor.p5js.org) - I've linked my GitHub to it for ease of sign in, however you can use whatever method you prefer.
...
async function setup() {
  ...
  // mine is colored_tilemap_packed.png
  spritesheet = await loadImage("assets/spritesheet.png");  
...
> All of your errors will go to your browser console!  Pop open the dev tools and keep an eye on the console to see your typos/errors/etc.
...
If you ran into issues or want to check your code, then this branch will put you into a working state for this step: [GitHub Repository - Step 1](https://github.com/efredericks/p5-ecs-demo/tree/part1)
...
If you ran into issues or want to check your code, then this branch will put you into a working state for this step: [GitHub Repository - Step 2](https://github.com/efredericks/p5-ecs-demo/tree/part2)
...
If you ran into issues or want to check your code, then this branch will put you into a working state for this step: [GitHub Repository - Step 3](https://github.com/efredericks/p5-ecs-demo/tree/part3)
