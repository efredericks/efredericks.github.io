...
<br />
<h2>what's going on with that homepage?</h2>
<p>I spend a lot of time in the <a href="https://p5js.org/" target="_blank">p5js editor</a>, mucking about with generative/algorithmic art.  It started as a mental release during the pandemic and transitioned into a research interest.  I've included some of the more interesting ones that are randomly selected on each page load.</p>